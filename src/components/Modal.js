...
const Modal = ({ visible, setModalVisibility }) => {
  ...
  if (visible) {
    return (
      ...
      --> */}
          <div class="inline-block align-bottom bg-gray-900 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <div class="bg-gray-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <h3 class="text-white text-lg leading-6 font-medium" id="modal-headline">
                    Welcome to <span className="text-green-500">Quick Spotify</span> !
              </h3>
                  <div class="mt-2">
