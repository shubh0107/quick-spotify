    ...
    return (
      <div className="h-screen flex items-center justify-center bg-gray-900">
        ...
        <Button onClick={callSpotifyAuthApi} classes="h-full w-1/3 flex items-center justify-center border-t-0 border-b-0 border-r-0 text-3xl group">
          <div className="flex items-center p-2 rounded-md group-hover:animate-bounce group-hover:bg-black group-hover:text-white transition-colors duration-200">
            Login
            <div className="h-8 w-8 ml-2">
              {callingAuthApi ? <Spinner /> : <SpotifyLogo />}
            </div>
          </div>
        </Button>
      </div >
